...
int32 AMatch3GameMode::GetRemainingTime()
{
	return FMath::CeilToInt(GetWorldTimerManager().GetTimerRemaining(GameOverTimer));
}



int32 AMatch3GameMode::GetDefaultGameTime()
{
	return FMath::CeilToInt(TimeRemaining);
}
